...
if __name__ == '__main__':
    ...
    ss = np.array( [[0.443518,  0.51302, 0.0, 0.0, 0.0, 0.0434624],[0.0,0.0527213,0.354255,0.0,0.0,0.593024],[0.502787,0.0,0.278159, 0.0, 0.219054, 0.0],[0.0,0.0,0.0,0.292049,0.322992,0.384959],[0.0,0.453191,0.0,0.51747,0.0293394,0.0],[0.0,0.2745,0.0,0.7255,0.0,0.0]])
    makeGammaMatrix(6,0.95,ss)
    # print aa
